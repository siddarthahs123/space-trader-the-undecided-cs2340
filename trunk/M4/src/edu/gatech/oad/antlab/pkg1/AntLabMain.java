...
public class AntLabMain {
	...
	public AntLabMain() {
		...
		ant21 = new AntLab21();
		ant22 = new AntLab22();
		// if you get an error here, you do not have resources.jar on the
		// classpath
		ant31 = new AntLab31();
	...
	public void printOutMessage() {
		...
		Person1 p1 = new Person1("Samarth ");
		toPrint += " " + p1.toString("sagarwal62");
		// Person2 replace P2 with your name
		// and ggg000x with your gt num
		Person2 p2 = new Person2("Bao ");
		toPrint += " " + p2.toString("bao3");
		// Person3 replace P3 with your name
		// and ggg000x with your gt num
		Person3 p3 = new Person3("Chris ");
		toPrint += " " + p3.toString("creynolds7");
		// Person4 replace P4 with your name
		// and ggg000x with your gt num
		Person4 p4 = new Person4("Justin ");
		toPrint += " " + p4.toString("jjustin3");
